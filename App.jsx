  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // the recipe library reset (see nicinsync_recipes_v5_german) runs
        ...
        if (key === "nicinsync_recipes" && window.localStorage.getItem("nicinsync_recipes_v5_german")) return;
...
function convertOpenRecipeToAppRecipe(r, idx) {
  ...
  return {
    ...
    steps: r.steps,
    why: `Klassisches deutsches Gericht aus einer offenen Rezeptsammlung. N\u00e4hrwerte sind aus den Zutaten gesch\u00e4tzt.`,
    color: phase.color,
    meat,
    fish,
    dairy,
...
export default function App() {
  ...
  useEffect(() => {
    try {
      if (!window.localStorage.getItem("nicinsync_recipes_v5_german")) {
        setRecipes(buildConvertedOpenRecipes());
        window.localStorage.setItem("nicinsync_recipes_v5_german", "1");
      }
    } catch (err) {
